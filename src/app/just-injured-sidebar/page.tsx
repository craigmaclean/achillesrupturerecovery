...
import { AlertCircle, Clock, Stethoscope, Home, Footprints, FileText, Heart, Activity, Menu } from "lucide-react";
...
export default function JustInjuredSidebarPage() {
  const sidebarSections = [
    { id: "signs", label: "Recognizing Signs" },
    { id: "immediate", label: "Immediate Steps" },
    { id: "diagnosis", label: "Diagnosis Process" },
    { id: "comfort", label: "Comfort Tips" },
          ...
          <SidebarContent>
            ...
            <div className="mt-auto p-4">
              <div className="bg-muted/30 rounded-lg p-4 border-2 border-dashed border-border">
                ...
                <p className="text-xs text-muted-foreground text-center mt-1">300x250</p>
              </div>
            </div>
          </SidebarContent>
        </Sidebar>
          ...
          <div className="sticky top-0 z-40 bg-card/95 backdrop-blur-sm border-b shadow-sm">
            <div className="flex items-center gap-4 px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="font-semibold text-lg">Just Injured?</h1>
              </div>
            </div>
          </div>

          {/* Hero Section */}
          <section className="py-12 px-4 bg-gradient-hero text-white">
